      ...
      <div class="flex items-center w-full">
        <div class="w-full">
            <div class="flex items-center justify-center mx-auto mb-1">
                ...
                <button data-tooltip-target="tooltip-pause" type="button" class="inline-flex items-center justify-center p-2.5 mx-2 font-medium bg-pink-600 rounded-full hover:bg-pink-700 group focus:ring-4 focus:ring-pink-300 focus:outline-none dark:focus:ring-pink-800">
